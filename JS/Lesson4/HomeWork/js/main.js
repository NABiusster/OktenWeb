...
document.write("створити функцію яка створює параграф з текстом. Текст задати через аргумент")
...
document.write("створити функцію яка створює ul з трьома елементами li. Текст li задати через аргумент всім однаковий. Кількість li визначається другим аргументом, який є числовим");

function createNLi(text, count) {
    document.write("<ul>");
...
document.write("створити функцію яка приймає масив примітивних елементів (числа,стрінги,булеві), та будує для них список")

function createLiFromArray(...array) {
    document.write("<ul>");
    for (let arrayElement of array) {
...
function createDivFromArrObject(array) {
    for (let arrayElement of array) {
        document.write("<div>");
